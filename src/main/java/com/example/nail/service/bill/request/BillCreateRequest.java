...
public class BillCreateRequest implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        String customerName = billCreateRequest.customerName;
        String customerPhone = billCreateRequest.customerPhone;
        String customerEmail = billCreateRequest.customerEmail;
        String customerQuantity = billCreateRequest.customerQuantity;
        List<String> idProducts = billCreateRequest.idProducts;
        List<String> idCombos = billCreateRequest.idCombos;
        SelectOptionRequest user = billCreateRequest.user;
        String  appointmentTime = billCreateRequest.appointmentTime;
